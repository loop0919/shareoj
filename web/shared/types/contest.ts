...
export type Contest = {
  ...
  status: 'draft' | 'scheduled' | 'running' | 'ended', canEdit: boolean, official: boolean, canViewSubmissions: boolean,
...
export const contestStatus = { draft: '未公開', scheduled: '開催予定', running: '開催中', ended: '終了' }
